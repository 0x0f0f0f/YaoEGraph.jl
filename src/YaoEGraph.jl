...
function EGraphs.extractnode(::EGraph, n::ENode{Gate}, extractor::Function)
    return Gate(extractor(n.args[2]), extractor(n.args[3]))
end

function EGraphs.extractnode(::EGraph, n::ENode{Ctrl}, extractor::Function)
    return Ctrl(extractor(n.args[2]), extractor(n.args[3]))
end
